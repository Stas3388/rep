...
async def transaction_create(transaction:TransactionCreate, db:AsyncSession = Depends(get_session), 
...
async def show_transaction(transaction_id: int, db = Depends(get_session), 
                           user_check = Depends(get_current_user)):
